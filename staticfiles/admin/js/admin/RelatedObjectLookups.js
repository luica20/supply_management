...
'use strict';
{
    ...
    function updateRelatedObjectLinks(triggeringLink) {
        ...
        if (value) {
            siblings.each(function() {
                const elm = $(this);
                elm.attr('href', elm.attr('product_images-href-template').replace('__fk__', value));
    ...
    $(document).ready(function() {
        setPopupIndex();
        $("a[product_images-popup-opener]").on('click', function(event) {
            event.preventDefault();
            opener.dismissRelatedLookupPopup(window, $(this).data("popup-opener"));
        });
        $('body').on('click', '.related-widget-wrapper-link[product_images-popup="yes"]', function(e) {
            e.preventDefault();
            if (this.href) {
